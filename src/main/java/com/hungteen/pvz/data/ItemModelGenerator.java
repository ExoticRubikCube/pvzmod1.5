    ...
    protected void registerModels() {
        ...
        for (Item i : ForgeRegistries.ITEMS) {
            ...
            if (i instanceof PVZSpawnEggItem) { // for spawn eggs
                addedItems.add(i);
                getBuilder(itemKey.getPath()).parent(getExistingFile(new ResourceLocation("minecraft", "item/template_spawn_egg")));
            } else if (i instanceof PlantCardItem) { // for plant cards
                IPlantType plant = ((PlantCardItem) i).plantType;
                ResourceLocation plantResource = new ResourceLocation(plant.getModID(), "screenshot/plant/" + plant);
                addedItems.add(i);
