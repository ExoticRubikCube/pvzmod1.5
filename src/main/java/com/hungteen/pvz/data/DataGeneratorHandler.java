...
import com.hungteen.pvz.data.tag.BiomeTagGen;
...
public class    DataGeneratorHandler {
    ...
    public static void gatherData(GatherDataEvent ev) {
        ...
        if (ev.includeServer()) {
            //for tags.
            BiomeTagGen biomeTagGenerator = new BiomeTagGen(ev.getGenerator(), helper);
            ev.getGenerator().addProvider(true, biomeTagGenerator);
