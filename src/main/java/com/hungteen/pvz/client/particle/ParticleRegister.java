...
public class ParticleRegister {
	...
	public static final RegistryObject<SimpleParticleType> RED_BOMB = PARTICLE_TYPES.register("red_bomb", () -> new SimpleParticleType(true));
	...
	public static final RegistryObject<SimpleParticleType> YELLOW_FLAME = PARTICLE_TYPES.register("yellow_flame", () -> new SimpleParticleType(true));
	public static final RegistryObject<SimpleParticleType> BLUE_FLAME = PARTICLE_TYPES.register("blue_flame", () -> new SimpleParticleType(true));
	public static final RegistryObject<SimpleParticleType> SLEEP = PARTICLE_TYPES.register("sleep", () -> new SimpleParticleType(true));
	...
	public static final RegistryObject<SimpleParticleType> DOOM = PARTICLE_TYPES.register("doom", () -> new SimpleParticleType(true));
