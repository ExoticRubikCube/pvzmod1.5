...
public class WinterMelonModel extends PVZPlantModel<WinterMelonEntity> {
	public static final ModelLayerLocation LAYER = new ModelLayerLocation(new ResourceLocation(PVZMod.MOD_ID, "winter_melon"), "main");
...
public WinterMelonModel(ModelPart root) {
		...
		this.melon = this.basket.getChild("melon");
		this.cube_r1 = this.melon.getChild("cube_r1");
		this.ice = this.basket.getChild("ice");
		this.ice1 = this.ice.getChild("ice1");
		this.bone = this.ice1.getChild("bone");
		this.cube_r2 = this.bone.getChild("cube_r2");
		this.bone2 = this.ice1.getChild("bone2");
		this.cube_r3 = this.bone2.getChild("cube_r3");
		this.bone3 = this.ice1.getChild("bone3");
		this.cube_r4 = this.bone3.getChild("cube_r4");
		this.bone4 = this.ice1.getChild("bone4");
		this.cube_r5 = this.bone4.getChild("cube_r5");
		this.bone5 = this.ice1.getChild("bone5");
		this.cube_r6 = this.bone5.getChild("cube_r6");
		this.bone6 = this.ice1.getChild("bone6");
		this.cube_r7 = this.bone6.getChild("cube_r7");
		this.bone7 = this.ice1.getChild("bone7");
		this.cube_r8 = this.bone7.getChild("cube_r8");
		this.ice2 = this.ice.getChild("ice2");
		this.bone13 = this.ice2.getChild("bone13");
		this.cube_r9 = this.bone13.getChild("cube_r9");
		this.bone14 = this.ice2.getChild("bone14");
		this.cube_r10 = this.bone14.getChild("cube_r10");
		this.bone15 = this.ice2.getChild("bone15");
		this.cube_r11 = this.bone15.getChild("cube_r11");
		this.bone16 = this.ice2.getChild("bone16");
		this.cube_r12 = this.bone16.getChild("cube_r12");
		this.bone17 = this.ice2.getChild("bone17");
		this.cube_r13 = this.bone17.getChild("cube_r13");
		this.bone18 = this.ice2.getChild("bone18");
		this.cube_r14 = this.bone18.getChild("cube_r14");
		this.bone19 = this.ice2.getChild("bone19");
		this.cube_r15 = this.bone19.getChild("cube_r15");
		this.ice3 = this.ice.getChild("ice3");
		this.bone8 = this.ice3.getChild("bone8");
		this.cube_r16 = this.bone8.getChild("cube_r16");
		this.bone9 = this.ice3.getChild("bone9");
		this.cube_r17 = this.bone9.getChild("cube_r17");
		this.bone10 = this.ice3.getChild("bone10");
		this.cube_r18 = this.bone10.getChild("cube_r18");
		this.bone11 = this.ice3.getChild("bone11");
		this.cube_r19 = this.bone11.getChild("cube_r19");
		this.bone12 = this.bone11.getChild("bone12");
		this.cube_r20 = this.bone12.getChild("cube_r20");
		this.ice4 = this.ice.getChild("ice4");
		this.bone20 = this.ice4.getChild("bone20");
		this.cube_r21 = this.bone20.getChild("cube_r21");
		this.bone21 = this.ice4.getChild("bone21");
		this.cube_r22 = this.bone21.getChild("cube_r22");
		this.bone22 = this.ice4.getChild("bone22");
		this.cube_r23 = this.bone22.getChild("cube_r23");
		this.bone23 = this.ice4.getChild("bone23");
		this.cube_r24 = this.bone23.getChild("cube_r24");
		this.bone24 = this.bone23.getChild("bone24");
		this.cube_r25 = this.bone24.getChild("cube_r25");
