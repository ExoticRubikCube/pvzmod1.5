...
public class GoldMagnetModel extends PVZPlantModel<GoldMagnetEntity> {
	public static final ModelLayerLocation LAYER = new ModelLayerLocation(new ResourceLocation(PVZMod.MOD_ID, "gold_magnet"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone15 = plate.addOrReplaceChild("bone15",
			CubeListBuilder.create()
		...
		PartDefinition bone16 = plate.addOrReplaceChild("bone16",
			CubeListBuilder.create()
				.texOffs(42, 37).addBox(-0.25F, -0.75F, -1.5F, 3.0F, 1.0F, 2.0F, new CubeDeformation(-0.35F)),
			PartPose.offsetAndRotation(1.75F, -0.75F, -1.0F, 0.5236F, 0.5236F, 0.5236F));
		PartDefinition bone17 = plate.addOrReplaceChild("bone17",
			CubeListBuilder.create()
				.texOffs(32, 37).addBox(-2.75F, -0.75F, -0.5F, 3.0F, 1.0F, 2.0F, new CubeDeformation(-0.35F)),
			PartPose.offsetAndRotation(-1.75F, -0.75F, 1.0F, -0.5236F, 0.5236F, -0.5236F));
		PartDefinition bone18 = plate.addOrReplaceChild("bone18",
			CubeListBuilder.create()
				.texOffs(24, 35).addBox(-0.25F, -0.75F, -0.5F, 3.0F, 1.0F, 2.0F, new CubeDeformation(-0.35F)),
			PartPose.offsetAndRotation(1.75F, -0.75F, 1.0F, -0.5236F, -0.5236F, 0.5236F));
		PartDefinition bone19 = plate.addOrReplaceChild("bone19",
			CubeListBuilder.create()
				.texOffs(53, 37).addBox(-2.75F, -0.75F, -1.5F, 3.0F, 1.0F, 2.0F, new CubeDeformation(-0.35F)),
			PartPose.offsetAndRotation(-1.75F, -0.75F, 0.5F, 0.0F, 0.0F, 0.3927F));
		PartDefinition bone20 = plate.addOrReplaceChild("bone20",
			CubeListBuilder.create()
				.texOffs(42, 37).addBox(-0.25F, -0.75F, -1.5F, 3.0F, 1.0F, 2.0F, new CubeDeformation(-0.35F)),
			PartPose.offsetAndRotation(1.75F, -0.75F, 0.5F, 0.0F, 0.0F, -0.3927F));
		PartDefinition magnet = total.addOrReplaceChild("magnet",
			CubeListBuilder.create()
		...
		PartDefinition base = total.addOrReplaceChild("base",
			CubeListBuilder.create(),
			PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition bone = base.addOrReplaceChild("bone",
			CubeListBuilder.create()
		...
		PartDefinition leave1 = base.addOrReplaceChild("leave1",
			CubeListBuilder.create()
