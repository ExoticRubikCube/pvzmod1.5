...
public class PumpkinZombieModel extends PVZZombieModel<PumpkinZombieEntity> {
	public static final ModelLayerLocation LAYER = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(PVZMod.MOD_ID, "pumpkin_zombie"), "main");
...
public PumpkinZombieModel(ModelPart root) {
		...
		this.helmet = this.up.getChild("helmet");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head_pd = up_pd.addOrReplaceChild("head",
			CubeListBuilder.create()
				.texOffs(16, 96).addBox(-8.0F, -17.0F, -8.0F, 16.0F, 16.0F, 16.0F),
			PartPose.offset(0.0F, -24.0F, 0.0F));
		PartDefinition helmet_pd = up_pd.addOrReplaceChild("helmet",
			CubeListBuilder.create()
				.texOffs(142, 4).addBox(-12.0F, -1.0F, -12.0F, 24.0F, 1.0F, 24.0F)
				.texOffs(140, 38).addBox(-12.0F, -17.0F, -12.0F, 24.0F, 16.0F, 1.0F)
				.texOffs(198, 39).addBox(-12.0F, -17.0F, 11.0F, 24.0F, 16.0F, 1.0F)
				.texOffs(140, 63).addBox(-12.0F, -17.0F, -11.0F, 1.0F, 16.0F, 22.0F)
				.texOffs(193, 65).addBox(11.0F, -17.0F, -11.0F, 1.0F, 16.0F, 22.0F),
			PartPose.offset(0.0F, -24.0F, 0.0F));
		PartDefinition bone_pd = helmet_pd.addOrReplaceChild("bone",
			CubeListBuilder.create()
				.texOffs(244, 111).addBox(-1.0F, -4.0F, -1.0F, 2.0F, 5.0F, 2.0F),
			PartPose.offsetAndRotation(0.0F, -17.0F, 0.0F, 0.0F, 0.0F, 0.3927F));
