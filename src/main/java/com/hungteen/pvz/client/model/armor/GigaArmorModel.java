...
public class GigaArmorModel extends HumanoidModel<LivingEntity> {
	...
	private static MeshDefinition createMesh() {
		...
		PartDefinition rightHandPd = rightArm.addOrReplaceChild("right_hand_armor",
			CubeListBuilder.create()
				...
				.texOffs(44, 51).addBox(-4.0F, -3.0F, 1.0F, 1.0F, 1.0F, 1.0F)
				.texOffs(44, 52).addBox(-4.0F, -3.0F, -2.0F, 1.0F, 1.0F, 1.0F)
				.texOffs(45, 46).addBox(-1.0F, -3.0F, 1.0F, 1.0F, 1.0F, 1.0F)
				.texOffs(46, 53).addBox(-1.0F, -3.0F, -2.0F, 1.0F, 1.0F, 1.0F),
		...
		PartDefinition leftHandPd = leftArm.addOrReplaceChild("left_hand_armor",
			CubeListBuilder.create()
				...
				.texOffs(44, 51).addBox(0.0F, -3.0F, 1.0F, 1.0F, 1.0F, 1.0F)
				.texOffs(44, 52).addBox(0.0F, -3.0F, -2.0F, 1.0F, 1.0F, 1.0F)
				.texOffs(45, 46).addBox(3.0F, -3.0F, 1.0F, 1.0F, 1.0F, 1.0F)
				.texOffs(46, 53).addBox(3.0F, -3.0F, -2.0F, 1.0F, 1.0F, 1.0F),
			PartPose.offset(1.0F, 0.0F, 0.0F));
