...
public class FootballZombieModel extends PVZZombieModel<FootballZombieEntity> {
	public static final ModelLayerLocation LAYER = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(PVZMod.MOD_ID, "football_zombie"), "main");
...
public FootballZombieModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition right_leg_pd = total_pd.addOrReplaceChild("right_leg",
			CubeListBuilder.create()
				.texOffs(32, 236).addBox(-1.0F, 17.0F, -2.0F, 4.0F, 12.0F, 4.0F)
				.texOffs(54, 242).addBox(-2.0F, 29.0F, -6.0F, 6.0F, 3.0F, 9.0F)
				.texOffs(88, 251).addBox(-2.0F, 28.0F, -6.0F, 6.0F, 1.0F, 1.0F)
				.texOffs(108, 232).addBox(-2.0F, -1.0F, -3.0F, 6.0F, 18.0F, 6.0F),
			PartPose.offset(-6.0F, -32.0F, 0.0F));
		...
		PartDefinition left_hand_pd = up_pd.addOrReplaceChild("left_hand",
			CubeListBuilder.create()
				.texOffs(3, 214).addBox(-5.0F, -5.0F, -5.0F, 20.0F, 1.0F, 10.0F)
		...
		PartDefinition right_hand_pd = up_pd.addOrReplaceChild("right_hand",
			CubeListBuilder.create()
				.texOffs(4, 143).addBox(-5.0F, -5.0F, -5.0F, 20.0F, 1.0F, 10.0F)
	...
	protected void doWalkAnimation(float limbSwing, float limbSwingAmount, float netHeadYaw, float headPitch) {
        ...
        this.right_hand.xRot = Mth.cos(limbSwing * 0.6662F) * 1.4F * limbSwingAmount / 3;
        this.left_hand.xRot = Mth.cos(limbSwing * 0.6662F + (float)Math.PI) * 1.4F * limbSwingAmount / 3;
	}
