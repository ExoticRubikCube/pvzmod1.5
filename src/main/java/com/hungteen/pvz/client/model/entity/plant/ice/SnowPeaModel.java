...
public class SnowPeaModel extends PlantShooterModel<SnowPeaEntity> {
	public static final ModelLayerLocation LAYER = new ModelLayerLocation(new ResourceLocation(PVZMod.MOD_ID, "snow_pea"), "main");
