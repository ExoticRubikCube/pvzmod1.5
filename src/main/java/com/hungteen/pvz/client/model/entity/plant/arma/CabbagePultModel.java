...
public class CabbagePultModel extends PVZPlantModel<CabbagePultEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cabbage = total.addOrReplaceChild("cabbage",
			CubeListBuilder.create()
		...
		PartDefinition dicoration = cabbage.addOrReplaceChild("dicoration",
			CubeListBuilder.create()
		...
		PartDefinition out = pult.addOrReplaceChild("out",
			CubeListBuilder.create()
		...
		PartDefinition bullet = out.addOrReplaceChild("bullet",
			CubeListBuilder.create()
