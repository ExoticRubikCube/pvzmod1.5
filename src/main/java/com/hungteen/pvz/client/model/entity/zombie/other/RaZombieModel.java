...
public class RaZombieModel extends PVZZombieModel<RaZombieEntity> {
	public static final ModelLayerLocation LAYER = new ModelLayerLocation(new ResourceLocation(PVZMod.MOD_ID, "ra_zombie"), "main");
...
public RaZombieModel(ModelPart root) {
		...
		this.collector = this.right_hand.getChild("collector");
		this.cube_r1 = this.collector.getChild("cube_r1");
		this.group2 = this.collector.getChild("group2");
		this.cube_r2 = this.group2.getChild("cube_r2");
		this.cube_r3 = this.group2.getChild("cube_r3");
		this.group3 = this.collector.getChild("group3");
		this.cube_r4 = this.group3.getChild("cube_r4");
