...
public CobCannonModel(ModelPart root) {
		...
		this.cube_r36 = root.getChild("cube_r36");
		this.cube_r37 = root.getChild("cube_r37");
		this.cube_r38 = root.getChild("cube_r38");
		this.cube_r39 = root.getChild("cube_r39");
		this.cube_r40 = root.getChild("cube_r40");
		this.cube_r41 = root.getChild("cube_r41");
		this.cube_r42 = root.getChild("cube_r42");
		this.cube_r43 = root.getChild("cube_r43");
		this.cube_r44 = root.getChild("cube_r44");
		this.cube_r45 = root.getChild("cube_r45");
		this.wheel4 = root.getChild("wheel4");
		this.cube_r46 = root.getChild("cube_r46");
		this.cube_r47 = root.getChild("cube_r47");
		this.cube_r48 = root.getChild("cube_r48");
		this.cube_r49 = root.getChild("cube_r49");
		this.cube_r50 = root.getChild("cube_r50");
		this.cube_r51 = root.getChild("cube_r51");
		this.cube_r52 = root.getChild("cube_r52");
		this.cube_r53 = root.getChild("cube_r53");
		this.cube_r54 = root.getChild("cube_r54");
		this.cube_r55 = root.getChild("cube_r55");
		this.cube_r56 = root.getChild("cube_r56");
		this.cube_r57 = root.getChild("cube_r57");
		this.cube_r58 = root.getChild("cube_r58");
		this.cube_r59 = root.getChild("cube_r59");
		this.cube_r60 = root.getChild("cube_r60");
		this.base = root.getChild("base");
		this.body = root.getChild("body");
		this.corn = root.getChild("corn");
		...
		this.cube_r61 = root.getChild("cube_r61");
		this.bone = root.getChild("bone");
		this.leaf2 = root.getChild("leaf2");
		this.l2 = root.getChild("l2");
		this.cube_r62 = root.getChild("cube_r62");
		this.bone2 = root.getChild("bone2");
		this.leaf3 = root.getChild("leaf3");
		this.l3 = root.getChild("l3");
		this.cube_r63 = root.getChild("cube_r63");
		this.bone3 = root.getChild("bone3");
		this.leaf4 = root.getChild("leaf4");
		this.l4 = root.getChild("l4");
		this.cube_r64 = root.getChild("cube_r64");
		this.bone4 = root.getChild("bone4");
		this.tail = root.getChild("tail");
		this.cube_r65 = root.getChild("cube_r65");
		this.cube_r66 = root.getChild("cube_r66");
		this.cube_r67 = root.getChild("cube_r67");
		this.cube_r68 = root.getChild("cube_r68");
