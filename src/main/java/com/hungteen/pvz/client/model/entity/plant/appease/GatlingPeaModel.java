...
public class GatlingPeaModel extends PlantShooterModel<GatlingPeaEntity> {
	public static final ModelLayerLocation LAYER = new ModelLayerLocation(new ResourceLocation(PVZMod.MOD_ID, "gatling_pea"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition barrel = head.addOrReplaceChild("barrel",
			CubeListBuilder.create()
