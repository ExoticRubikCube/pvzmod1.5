...
public class ScreenDoorZombieRender extends PVZZombieRender<ScreenDoorZombieEntity>{
	...
	public ScreenDoorZombieRender(EntityRendererProvider.Context context) {
		super(context, new ScreenDoorZombieModel(context.bakeLayer(ScreenDoorZombieModel.LAYER)), 0.5f);
	}
