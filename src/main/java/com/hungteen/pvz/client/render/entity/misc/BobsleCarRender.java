...
public class BobsleCarRender extends EntityRenderer<BobsleCarEntity>{
	...
	public BobsleCarRender(EntityRendererProvider.Context context) {
		super(context);
		this.model=new BobsleCarModel(context.bakeLayer(BobsleCarModel.LAYER));
	}

	@Override
	public void render(BobsleCarEntity entityIn, float entityYaw, float partialTicks, PoseStack matrixStackIn,
