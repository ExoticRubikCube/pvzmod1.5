...
public class GigaFootballZombieRender extends PVZZombieRender<GigaFootballZombieEntity>{
	...
	public GigaFootballZombieRender(EntityRendererProvider.Context context) {
		super(context, new GigaFootballZombieModel(context.bakeLayer(GigaFootballZombieModel.LAYER)), 0.5f);
	}
