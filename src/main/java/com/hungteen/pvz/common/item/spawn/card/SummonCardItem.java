...
public abstract class SummonCardItem extends Item{
	...
	public void appendHoverText(ItemStack stack, Level worldIn, List<Component> tooltip, TooltipFlag flagIn) {
		...
		tooltip.add(Component.translatable("tooltip.pvz.card_cd", Component.translatable(getCardCoolDown(stack).getTranslateKey()).getString()).withStyle(ChatFormatting.AQUA));
